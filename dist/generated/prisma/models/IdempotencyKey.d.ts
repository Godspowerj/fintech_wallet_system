...
export type IdempotencyKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "key" | "requestHash" | "response" | "createdAt" | "expiresAt", ExtArgs["result"]["idempotencyKey"]>;
