...
exports.FraudDetectedError = exports.WalletLockedError = exports.InsufficientFundsError = exports.ValidationError = exports.ConflictError = exports.NotFoundError = exports.ForbiddenError = exports.UnauthorizedError = exports.BadRequestError = exports.AppError = void 0;
/**
 * BASE ERROR CLASS
 *
...
class AppError extends Error {
    ...
    message;
    isOperational;
    constructor(statusCode, message, isOperational = true // Operational errors are expected (not bugs)
    ) {
        super(message);
...
exports.FraudDetectedError = FraudDetectedError;
